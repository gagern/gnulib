...
generated_files_sharing_po = \
  $(if $(wildcard $(srcdir)/lib/po/POTFILES.in),,$(generated_files))
...
sc_po_check:
	@if test -f $(po_file); then					\
	  ...
	  files=;							\
	  for file in $$($(VC_LIST_EXCEPT))				\
              $(generated_files_sharing_po); do				\
...
alpha beta stable: syntax-check writable-files $(submodule-checks)
...
refresh-po:
	...
	| $(SED) -e 's/\.po//;s,$(PODIR)/,,' | sort -u >> $(PODIR)/LINGUAS
